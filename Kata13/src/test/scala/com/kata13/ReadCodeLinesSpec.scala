...
class ReadCodeLinesSpec extends FlatSpec with Matchers {
  ...
  "Given an input directory" should "give total number of lines of code included in directory" in {
    ...
    ReadCodeLines.readFromDir(getListOfFiles("src/test/Resources")) shouldEqual 35
   }
